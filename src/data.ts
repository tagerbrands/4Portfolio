...
export const EVL2_STUDENTVERSIE_DEFAULT_PORTFOLIO: Record<string, any[]> = {
  '2.1': [
    {
      id: '2.1-part-0',
      text: 'concretiseert een vraagstuk uit de beroepscontext',
      colorClass: 'bg-blue-200 text-blue-900',
      evidence: [
        { id: '2.1-ev-1', name: 'Literatuuronderzoek', type: 'product', stakeholders: 'Peers, Methodologisch expert' },
        { id: '2.1-ev-2', name: 'Gespreksverslag met opdrachtgever', type: 'practice', stakeholders: 'Opdrachtgever' }
      ]
    },
    {
      id: '2.1-part-1',
      text: 'vertaalt dit naar een relevante en onderzoekbare opdracht',
      colorClass: 'bg-emerald-200 text-emerald-900',
      evidence: [
        { id: '2.1-ev-3', name: 'Gespreksverslag met opdrachtgever', type: 'practice', stakeholders: 'Opdrachtgever' },
        { id: '2.1-ev-4', name: 'Onderzoeksvraag', type: 'product', stakeholders: 'Methodologisch expert' }
      ]
    },
    {
      id: '2.1-part-2',
      text: 'op basis van ontwikkelingen binnen het eigen vakgebied',
      colorClass: 'bg-purple-200 text-purple-900',
      evidence: [
        { id: '2.1-ev-5', name: 'Vraagarticulatieformulier', type: 'product', stakeholders: 'Opdrachtgever, Methodologisch expert' },
        { id: '2.1-ev-6', name: 'Literatuuronderzoek', type: 'product', stakeholders: 'Methodologisch expert, Peers' }
      ]
    },
    {
      id: '2.1-part-3',
      text: 'in afstemming met de relevante stakeholders',
      colorClass: 'bg-amber-200 text-amber-900',
      evidence: [
        { id: '2.1-ev-7', name: 'Stakeholderanalyse', type: 'product', stakeholders: 'Methodologisch expert, Opdrachtgever' },
        { id: '2.1-ev-8', name: 'Gespreksverslag met opdrachtgever', type: 'practice', stakeholders: 'Opdrachtgever' }
      ]
    }
  ],
  '2.2': [
    {
      id: '2.2-part-0',
      text: 'ontwerpt in afstemming met de stakeholders een plan van aanpak',
      colorClass: 'bg-blue-200 text-blue-900',
      evidence: [
        { id: '2.2-ev-1', name: 'Evaluatie met stakeholders', type: 'practice', stakeholders: 'Opdrachtgever, Vakinhoudelijk expert, Peers' }
      ]
    },
    {
      id: '2.2-part-1',
      text: 'navolgbare onderzoeksmethode',
      colorClass: 'bg-emerald-200 text-emerald-900',
      evidence: [
        { id: '2.2-ev-2', name: 'Hoofd- en deelvragen', type: 'product', stakeholders: 'Methodologisch expert, Peers' }
      ]
    },
    {
      id: '2.2-part-2',
      text: 'een oplossing(srichting) voor een vraagstuk uit de beroepscontext',
      colorClass: 'bg-purple-200 text-purple-900',
      evidence: [
        { id: '2.2-ev-3', name: 'Praktijkprobleem', type: 'product', stakeholders: 'Opdrachtgever, Vakinhoudelijk expert' },
        { id: '2.2-ev-4', name: 'Aanleiding', type: 'product', stakeholders: 'Opdrachtgever, Vakinhoudelijk expert, Peers' },
        { id: '2.2-ev-5', name: 'Probleemanalyse', type: 'product', stakeholders: 'Vakinhoudelijk expert, Methodologisch expert' },
        { id: '2.2-ev-6', name: 'Relevantie voor de beroepspraktijk', type: 'product', stakeholders: 'Opdrachtgever' },
        { id: '2.2-ev-7', name: 'Relevantie van hypothesetest', type: 'practice', stakeholders: 'Opdrachtgever, Methodologisch expert, Vakinhoudelijk expert' }
      ]
    }
  ],
  '2.3': [
    {
      id: '2.3-part-0',
      text: 'handelt binnen het doen van het gehele onderzoek conform de huidige wet- en regelgeving en handelt hierbij conform de ethische richtlijnen.',
      colorClass: 'bg-blue-200 text-blue-900',
      evidence: [
        { id: '2.3-ev-1', name: 'Omgang met data', type: 'practice', stakeholders: 'Opdrachtgever, Vakinhoudelijk expert' },
        { id: '2.3-ev-2', name: 'Toetstemmingsverklaring gebruiken', type: 'practice', stakeholders: 'Opdrachtgever, Vakinhoudelijk expert' },
        { id: '2.3-ev-3', name: 'Informatiebrief', type: 'product', stakeholders: 'Vakinhoudelijk expert' },
        { id: '2.3-ev-4', name: 'Logboek en reflectie', type: 'process', stakeholders: 'Coach, Vakinhoudelijk expert' }
      ]
    }
  ],
  '2.4': [
    {
      id: '2.4-part-0',
      text: 'analyseert een vraagstuk systematisch',
      colorClass: 'bg-blue-200 text-blue-900',
      evidence: [
        { id: '2.4-ev-1', name: 'Onderzoeksplan', type: 'product', stakeholders: 'Vakinhoudelijk expert' },
        { id: '2.4-ev-2', name: 'Procesanalyse', type: 'process', stakeholders: 'Peers, Vakinhoudelijk expert' },
        { id: '2.4-ev-3', name: 'Stakeholderanalyse', type: 'product', stakeholders: 'Vakinhoudelijk expert' },
        { id: '2.4-ev-4', name: 'Interviewprotocol', type: 'product', stakeholders: 'Vakinhoudelijk expert' },
        { id: '2.4-ev-5', name: 'Literatuuronderzoek', type: 'product', stakeholders: 'Peers, Opdrachtgever, Vakinhoudelijk expert' }
      ]
    },
    {
      id: '2.4-part-1',
      text: 'interpreteert de resultaten',
      colorClass: 'bg-emerald-200 text-emerald-900',
      evidence: [
        { id: '2.4-ev-6', name: 'Analyseverslag', type: 'product', stakeholders: 'Peers, Vakinhoudelijk expert' },
        { id: '2.4-ev-7', name: 'Coderingsoverzicht', type: 'product', stakeholders: 'Peers, Vakinhoudelijk expert' },
        { id: '2.4-ev-8', name: 'Samenvatting van bevindingen', type: 'product', stakeholders: 'Peers, Vakinhoudelijk expert' }
      ]
    },
    {
      id: '2.4-part-2',
      text: 'onderbouwde conclusie te komen en formuleert aanbevelingen',
      colorClass: 'bg-purple-200 text-purple-900',
      evidence: [
        { id: '2.4-ev-9', name: 'Conclusiedocument', type: 'product', stakeholders: 'Peers, Vakinhoudelijk expert' },
        { id: '2.4-ev-10', name: 'Aanbevelingsrapport', type: 'product', stakeholders: 'Opdrachtgever, Peers' },
        { id: '2.4-ev-11', name: 'Samenvatting van bevindingen', type: 'product', stakeholders: 'Peers, Vakinhoudelijk expert' }
      ]
    }
  ],
  '2.5': [
    {
      id: '2.5-part-0',
      text: 'creëert aan de hand van een vraagstuk een passende oplossing(srichting) dan wel aanbevelingen voor de praktijk',
      colorClass: 'bg-blue-200 text-blue-900',
      evidence: [
        { id: '2.5-ev-1', name: 'Concept-oplossingsrichtingen', type: 'process', stakeholders: 'Opdrachtgever' },
        { id: '2.5-ev-2', name: 'Ontwerpcriteria', type: 'product', stakeholders: 'Vakinhoudelijk expert' },
        { id: '2.5-ev-3', name: "Scenario's schetsen", type: 'process', stakeholders: 'Opdrachtgever' }
      ]
    },
    {
      id: '2.5-part-1',
      text: 'aansluiten bij het verandervermogen van de beroepspraktijk, stakeholders en organisatie(s) ter voorbereiding van implementatie',
      colorClass: 'bg-emerald-200 text-emerald-900',
      evidence: [
        { id: '2.5-ev-4', name: 'Implementatieplan', type: 'product', stakeholders: 'Opdrachtgever, Peers, Vakinhoudelijk expert' },
        { id: '2.5-ev-5', name: 'Organisatieanalyse', type: 'product', stakeholders: 'Opdrachtgever, Peers' }
      ]
    }
  ],
  '2.6': [
    {
      id: '2.6-part-0',
      text: 'communiceert met de stakeholders op een professionele en doeltreffende manier over een passende oplossing/aanbeveling',
      colorClass: 'bg-blue-200 text-blue-900',
      evidence: [
        { id: '2.6-ev-1', name: 'Reflectieverslag communicatie', type: 'product', stakeholders: 'Opdrachtgever, Peers, Vakinhoudelijk expert' },
        { id: '2.6-ev-2', name: 'Implementatieplan', type: 'product', stakeholders: 'Opdrachtgever, Vakinhoudelijk expert' },
        { id: '2.6-ev-3', name: 'Product of proces dat impact maakt', type: 'product', stakeholders: 'Opdrachtgever, Vakinhoudelijk expert' }
      ]
    },
    {
      id: '2.6-part-1',
      text: 'om zo impact te realiseren in de beroepspraktijk',
      colorClass: 'bg-emerald-200 text-emerald-900',
      evidence: [
        { id: '2.6-ev-4', name: 'Communicatie over product/proces', type: 'practice', stakeholders: 'Opdrachtgever, Vakinhoudelijk expert' }
      ]
    }
  ],
  '2.7': [
    {
      id: '2.7-part-0',
      text: 'toont een positief kritische houding',
      colorClass: 'bg-blue-200 text-blue-900',
      evidence: [
        { id: '2.7-ev-1', name: 'Feedback op onderzoekende houding', type: 'process', stakeholders: 'Peers, Opdrachtgever, Coach, Vakinhoudelijk expert' }
      ]
    },
    {
      id: '2.7-part-1',
      text: 'vraagt feedback op het onderzoeksproces, reflecteert hierop en past dit toe op de eigen ontwikkeldoelen',
      colorClass: 'bg-emerald-200 text-emerald-900',
      evidence: [
        { id: '2.7-ev-2', name: 'Terugkoppeling verwerkte feedback', type: 'process', stakeholders: 'Peers, Opdrachtgever, Coach, Vakinhoudelijk expert' },
        { id: '2.7-ev-3', name: 'Reflectie op ontwikkeldoelen', type: 'process', stakeholders: 'Coach' },
        { id: '2.7-ev-4', name: 'SWOT-analyse', type: 'product', stakeholders: 'Coach, Peers' }
      ]
    },
    {
      id: '2.7-part-2',
      text: 'geeft (peer)feedback voor de ontwikkeling van peers.',
      colorClass: 'bg-purple-200 text-purple-900',
      evidence: [
        { id: '2.7-ev-5', name: 'Reflectieverslag', type: 'product', stakeholders: 'Peers, Coach' }
      ]
    }
  ]
};

export const AFSTUDEERONDERZOEK_DEFAULT_PORTFOLIO = EVL2_STUDENTVERSIE_DEFAULT_PORTFOLIO;
